...
> 原文:[https://hack aday . com/2018/08/20/simple-esp 8266-weather-station-using-blynk/](https://hackaday.com/2018/08/20/simple-esp8266-weather-station-using-blynk/)
...
[![](../Images/8af3721a90b9459b64720fb91f660e1b.png)](https://hackaday.com/wp-content/uploads/2018/08/espweath_detail.jpg) 这个由【希亚姆·拉维】组装的简单的[室内温度和湿度传感器展示了一个使用 Blynk 解决问题的可能方案。在休息后的视频中，他首先引导您完成演示硬件的布线，然后继续创建 Blynk 接口。虽然它可能不是所有应用的理想解决方案，但它确实向您展示了如何快速地从工作台上的几个组件转变为显示有用的数据。](https://github.com/theTechnowright/DIY-Weather-Station)
