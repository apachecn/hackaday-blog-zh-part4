...
> 原文:[https://hack aday . com/2018/09/19/industrial-3d-printing-uses-layers-like-we ve-never-seen-before/](https://hackaday.com/2018/09/19/industrial-3d-printing-uses-layers-like-weve-never-seen-before/)
...
> 当几何图形的 Z 高度输入印刷机时，印刷机将停止在所需的高度。我们将任何膨胀/收缩都考虑在内，它会相应地进行调整。但简短问题的长答案是，精度仍在 50-200 微米范围内。
 ...
 [![Single sheet of substrate thermoplastic](../Images/8daaac7985a0ed7e1aa51aa8a3b7f590.png "single-layer-of thermoplastic-on-substrate")](https://hackaday.com/2018/09/19/industrial-3d-printing-uses-layers-like-weve-never-seen-before/single-layer-of-thermoplastic-on-substrate/) Single sheet of substrate thermoplastic [![Sheet printer](../Images/6a375b55c5b98ac87865b90869f5efdc.png "impossible-objects-sheet-layer-printer")](https://hackaday.com/2018/09/19/industrial-3d-printing-uses-layers-like-weve-never-seen-before/impossible-objects-sheet-layer-printer/) Sheet printer

在这个过程中使用的衬底是非常薄和纤细的。打印机本身通过使用喷墨打印来沉积粘合剂的过程来移动基底。然后，将粉末状热塑性塑料涂在粘合剂上，多余的部分回收。这些层在机器末端自动按顺序堆叠。

 [![Compressed and baked part](../Images/d5b4fb1b3581775155973e726d83c290.png "pressed-and-baked-layers")](https://hackaday.com/2018/09/19/industrial-3d-printing-uses-layers-like-weve-never-seen-before/pressed-and-baked-layers/) Compressed and baked part [![Half of substrate removed](../Images/92c8d6ddf61435b3d22e05276f8dee4e.png "partially-bead-blasted-print-sample")](https://hackaday.com/2018/09/19/industrial-3d-printing-uses-layers-like-weve-never-seen-before/partially-bead-blasted-print-sample/) Half of substrate removed

该过程的第二部分是在压机中压缩这些层，并烘烤它们以将热塑性塑料熔化成固体。然后使用喷丸处理去除多余的基底。根据您的应用，零件现在可以使用，或者可以通过机械加工、添加螺纹嵌件或其他复合材料常用工艺进行进一步加工。

 [![Material examples](../Images/7ced2c232fa49182a7564e465d5d10fe.png "material-samples")](https://hackaday.com/2018/09/19/industrial-3d-printing-uses-layers-like-weve-never-seen-before/material-samples/) Material examples [![Carbon Fiber PEEK jig for wave soldering](../Images/c7629275a0a5e34546fd41d9a42d6d75.png "carbon-fiber-peek-impossible-objects-wave-soldering-jig")](https://hackaday.com/2018/09/19/industrial-3d-printing-uses-layers-like-weve-never-seen-before/carbon-fiber-peek-impossible-objects-wave-soldering-jig/) Carbon Fiber PEEK jig for wave soldering

有一系列材料可用于这项技术。它们取决于所选择的基底和热塑性塑料。他们手头上一个更有趣的例子是由碳纤维增强聚醚醚酮(PEEK)制成的。这种材料耐热性极好，拿在手里感觉像金属。这个特殊的演示是一个夹具，用于在波峰焊接过程中固定 PCB。

 [![imts-impossible-objects-printed-example2](../Images/e5518b0994a83728c47eed80e64a474d.png "imts-impossible-objects-printed-example2")](https://hackaday.com/2018/09/19/industrial-3d-printing-uses-layers-like-weve-never-seen-before/imts-impossible-objects-printed-example2/)  [![imts-impossible-objects-detailed-part](../Images/e517149c1833bcb0498d6178d8b96156.png "imts-impossible-objects-detailed-part")](https://hackaday.com/2018/09/19/industrial-3d-printing-uses-layers-like-weve-never-seen-before/imts-impossible-objects-detailed-part/)  [![imts-impossible-objects-printed-example](../Images/ed2532a9d79fd1c62af319c21aaaa4e6.png "imts-impossible-objects-printed-example")](https://hackaday.com/2018/09/19/industrial-3d-printing-uses-layers-like-weve-never-seen-before/imts-impossible-objects-printed-example/) 
