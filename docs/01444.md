...
> 原文:[https://hack aday . com/2018/12/07/magic-wand-learning-spells-through-machine-learning-and-an-IMU/](https://hackaday.com/2018/12/07/magic-wand-learns-spells-through-machine-learning-and-an-imu/)
...
[![](../Images/c241467a1855a7da03e3083e6ce30d6e.png)](https://hackaday.com/wp-content/uploads/2018/12/potter.png) 软件的实用方面使用 Python 和一些数值库以及 [scikit-learn](https://scikit-learn.org) 来处理深度学习方面。Plot.ly 和 Jupyter Notebook 也提供了方便的工具。
