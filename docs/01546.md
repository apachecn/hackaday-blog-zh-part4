...
> 原文:[https://hack aday . com/2019/01/18/Oreo-construction-hiding-your-components-inside-the-PCB/](https://hackaday.com/2019/01/18/oreo-construction-hiding-your-components-inside-the-pcb/)

最近几个月，将元件隐藏在电路板内部的能力已经成为人们感兴趣的项目。我们*可以*将此追溯到蓬勃发展的 badgelife 运动，工程师们在那里创造出美丽的电子艺术作品。我们也可以将这种兴趣归因于[彭博的*大黑客*T5】，乔丹·罗伯逊和迈克尔·莱利断言苹果是中国利用嵌入主板的组件进行间谍活动的目标。大黑客的故事是有根据的，但是到目前为止还没有证据表明这种黑客的存在，相关的公司和政府都否认有类似的事情存在。](https://www.bloomberg.com/news/features/2018-10-04/the-big-hack-how-china-used-a-tiny-chip-to-infiltrate-america-s-top-companies)
...
[![](../Images/612fb9dfc909dfafdf6c07fe3c95b1f9.png)](https://hackaday.com/wp-content/uploads/2018/12/r4a1916_small.jpg)
...
对于这种构建，我通过用焊料将 PCB 层机械结合在一起，稍微扩展了这些技术。这之前是由 Voja Antonic 和他用 FR4 建造围栏的工作完成的。他的方法是在外壳的四周制造一条裸铜带。通过以正确的角度安装外壳的这些侧面，将 PCB 的两个平面焊接成三维形状就像在周边裸露的铜上运行烙铁一样简单。
 ...
 [![Each layer of the stack has a thin strip of exposed copper running around the perimeter.](../Images/2fc0e465b0f13eb5f454b6c201433c5e.png "perimeteredge")](https://hackaday.com/2019/01/18/oreo-construction-hiding-your-components-inside-the-pcb/perimeteredge/) Each layer of the stack has a thin strip of exposed copper running around the perimeter. [![For assembly, the perimeter copper layer is covered in solder paste](../Images/a17142588f6cc95e4a63c41325d046ee.png "perimeterpaste")](https://hackaday.com/2019/01/18/oreo-construction-hiding-your-components-inside-the-pcb/perimeterpaste/) For assembly, the perimeter copper layer is covered in solder paste

叠层中的每个 PCB 都有裸露的铜线。通过使用焊膏，将电路板夹紧在一起，就可以进行回流焊接了。

 [![Assembly is aided with Kapton tape](../Images/c32b7b9a0b78d576edda962bbf8f1c72.png "kapton")](https://i0.wp.com/hackaday.com/wp-content/uploads/2018/12/kapton.jpg?ssl=1) Assembly is aided with Kapton tape [![The finished edge of the PCB stack. This can be cleaned up even more with a bit of 800 grit sandpaper](../Images/d08001029e4681bb745c33bc0465f18e.png "bondededge")](https://i0.wp.com/hackaday.com/wp-content/uploads/2018/12/bondededge.jpg?ssl=1) The finished edge of the PCB stack. This can be cleaned up even more with a bit of 800 grit sandpaper
...
[![](../Images/41725f7bdd9690d27af0b866ed137a07.png)](https://hackaday.com/wp-content/uploads/2018/12/Dti-xQWWsAA8sMO.jpg)
...
[![](../Images/fbe505cd42c0dd879910cafa3105d1be.png)](https://hackaday.com/wp-content/uploads/2018/12/Layer2002.png)
...
[![](../Images/3001d849dc4ec10a9ca969ad91539799.png)](https://hackaday.com/wp-content/uploads/2018/12/cutouts.jpg)
...
[![](../Images/56f77bd2d61027845a0a3ba60672f641.png)](https://hackaday.com/wp-content/uploads/2018/12/somethingstupid.png)
