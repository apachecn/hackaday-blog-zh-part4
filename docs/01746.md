...
> 原文:[https://hack aday . com/2019/01/08/an-electronic-love-letter-to-wind/](https://hackaday.com/2019/01/08/an-electronic-love-letter-to-the-wind/)
...
433 MHZ 显示器内置在灯笼的框架中，在 LED 读数器上显示当前时间和温度，在 2.2 英寸的 ILI9341 TFT 屏幕上显示历史风和温度图表，该屏幕[Richard]已旋转为纵向布局。顶部有一个红灯，每当收到信号时就会闪烁，表明系统正在工作，甚至还有一个触摸传感器，如果你不想看完整的图表，可以用它来关闭 TFT 屏幕。
 ...
 [![wind_detail](../Images/b8838a78e19c9041b2185c33ccbfce7e.png "wind_detail")](https://hackaday.com/2019/01/08/an-electronic-love-letter-to-the-wind/wind_detail-2/)  [![wind_detail2](../Images/35223ccb3aa92530f1e83d5eca610d1b.png "wind_detail2")](https://hackaday.com/2019/01/08/an-electronic-love-letter-to-the-wind/wind_detail2/) 
