...
> 原文:[https://hack aday . com/2019/04/09/用智能魔杖制作生日派对/](https://hackaday.com/2019/04/09/making-a-birthday-party-magical-with-smart-wands/)
...
[![](../Images/d1d92cd8e82487390cc460d387185c63.png)](https://hackaday.com/wp-content/uploads/2019/04/magicwand_detail.jpg)
...
[![](../Images/c1a1ffccf13ba77517e1affc0ddc03c4.png)](https://hackaday.com/wp-content/uploads/2019/04/magicwand_detail2.jpg) 该项目的最后一部分是从他的红外摄像机中获取视频流，并对其进行处理，以检测魔杖尖端的明亮光芒。对于视频的每一帧，背景首先被移除，然后任何不超过设定亮度水平的剩余像素被忽略。最终结果是一个代表魔杖尖端的孤立光点，它可以被馈入 Open CV 的光流函数，以向[Adam]显示用户试图做出的形状。从那里，他的软件只需要将形状与其中一个股票“咒语”匹配，并用 Home Assistant 执行适当的功能(如改变房间内灯光的颜色)。
