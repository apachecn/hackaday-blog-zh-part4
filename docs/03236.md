...
> 原文:[https://hack aday . com/2019/06/06/designing-a-drone-to-fire from-a-榴弹发射器/](https://hackaday.com/2019/06/06/designing-a-drone-to-fire-from-a-grenade-launcher/)
...
[![](../Images/0e9ad71d95706efcf6295bacff8f7271.png)](https://hackaday.com/wp-content/uploads/2019/06/nadedrone_detail.jpg) 把一架有翼飞机装进 40 毫米发射筒的唯一方法是把它折叠起来，到目前为止，这也是[格里奇]努力的方向。他的无人机的机翼将使用一个刚性的前缘，在展开之前可以折叠平整。当处于飞行模式时，附着在无人机机身和前缘之间的防撕裂尼龙将被拉伸以形成实际的机翼表面；把它想象成蝙蝠的翅膀。一个类似的技巧将被用于飞行器后部的两个操纵面。
