...
> 原文：<https://hackaday.com/2019/12/02/winter-is-coming-this-clock-will-let-you-know-when/>
...
[![](img/53a19eb83be269ac983801d436cc8c21.png)](https://hackaday.com/wp-content/uploads/2019/11/gotclock_detail.jpg) 受 HBO 系列标志性开场序列的启发，3D 打印模型的元素在主题曲播放时旋转，由 DFPlayer 迷你 MP3 播放器模块和 2 瓦小扬声器提供。音频硬件、电机和前面的四位 LED 显示模块都连接到带有定制 PCB 屏蔽的 Arduino，使时钟内部具有非常干净和专业的外观。
