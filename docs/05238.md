...
> 原文:[https://hack aday . com/2019/12/26/custom-control-panels-with-photography metry/](https://hackaday.com/2019/12/26/custom-control-panels-with-photogrammetry/)
...
[![](../Images/40a7c8913a8eaa470c0cfb5e7bd7f5ea.png)](https://hackaday.com/wp-content/uploads/2019/12/3dpanel_detail.jpg) 这本身就是一个足够简洁的技巧，但我们特别喜欢这个视频的是[Mangy_Dog]传递的关于增加视觉复杂性以改善最终结果的提示。基本上，该软件正在寻找可识别的表面细节来拼凑，所以你可以像一个蹒跚学步的孩子一样，通过使用一些不同颜色的标记在整个表面上画画来使事情变得简单一些。这可能看起来很疯狂，但所有这些线条给了软件一些定位点，帮助它理清形状的细微差别。
