...
> 原文:[https://hack aday . com/2020/02/18/mqtt-and-the-internet-of-conference-badges/](https://hackaday.com/2020/02/18/mqtt-and-the-internet-of-conference-badges/)
...
[![](../Images/e5d6a5207cc499cb6f3e988bc6dd6020.png)](https://hackaday.com/wp-content/uploads/2020/02/cloudbadge_detail.jpg) 由于这更多的是一个软件实验，所有的硬件都是现成的。徽章本身是一个 Adafruit PyBadge，通常没有任何联网功能，但背面有一个羽毛兼容的标题。除此之外,[Ayan]还增加了一个空运翼，这使他可以将 ESP32 用作协处理器。他还在挂绳上添加了一条 NeoPixel LEDs，不过如果你不想引起太多关注，这些 led 当然可以省去。
