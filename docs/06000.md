...
> 原文:[https://hack aday . com/2020/03/22/compliant-quadruped-legs-using-servos/](https://hackaday.com/2020/03/22/compliant-quadruped-legs-using-servos/)
...
![](../Images/102e578fccf6e9701baaebc32421394c.png)3D 打印的腿部机构有两个关节(髋关节和膝关节)，每个关节都有一个 RC 伺服驱动。为了使关节柔顺，两者都装有弹簧来吸收外力，偏转由霍尔效应传感器检测，每侧都有移动的磁体。使用来自霍尔效应传感器的输入，伺服机构可以跟随偏转，并在力消散后平稳地返回到其原始位置。这是一个简单的技术，但它显示了很多承诺。休息后看视频。
