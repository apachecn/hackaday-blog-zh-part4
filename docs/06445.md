...
> 原文:[https://hack aday . com/2020/05/21/Linux-fu-alternative-shell/](https://hackaday.com/2020/05/21/linux-fu-alternative-shells/)
...
[![](../Images/1e3e467f342970518c104812c03d1a29.png) ](https://hackaday.com/wp-content/uploads/2020/04/fish.jpg) `Fish`不是以任何人的名字命名的——甚至不是一个电视侦探。它代表友好的交互式外壳。与`ksh`、`ash`、`dash`、`bash`不同的是，`fish`并不试图兼容旧的经典 shell 程序。相反，它试图对用户非常友好。例如，当您键入内容时，它会自动给出建议。
