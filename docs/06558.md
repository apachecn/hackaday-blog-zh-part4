...
> 原文:[https://hack aday . com/2020/05/13/blinken lights-for-your-parallel-port/](https://hackaday.com/2020/05/13/blinkenlights-for-your-parallel-port/)
...
[![](../Images/bca20d7a1c0e25866825df8aa66893c6.png)](https://hackaday.com/wp-content/uploads/2020/05/lptled_detail.png) 为了解决他的计算机和 CNC 路由器之间的一些通信问题，[Jeremy]想出了一个方便的小工具，可以让他实时可视化通过并行端口每个引脚的数据。即使在房间的另一边，他也能一眼看出通信是否活跃，并以敏锐的眼光确定他是否获得了双向通信。
