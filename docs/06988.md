...
> 原文:[https://hack aday . com/2020/06/25/用虚拟旋转斜盘建造并驾驶直升机/](https://hackaday.com/2020/06/25/building-and-flying-a-helicopter-with-a-virtual-swashplate/)
...
[![](../Images/2c4de16f939099098d8358835238666a.png)](https://hackaday.com/wp-content/uploads/2020/06/Peek-2020-06-24-10-13.gif) 你只需要看慢动作视频就能明白发生了什么:随着电机速度在一次旋转中变化，铰接转子叶片的尖端在周期的受控部分领先和滞后主轴。铰链是倾斜的，这意味着每个旋翼桨叶的迎角在每次旋转过程中都会发生变化——这正是旋转斜盘通常实现的效果。正如你所想象的，当一个马达以 3000 转/分的速度旋转时，在一次旋转中调整它的速度不是一件容易的事，[汤姆]在他的第二个频道的[后续视频](https://www.youtube.com/watch?v=Y31BhQToh_U)中详细介绍了这一点。
