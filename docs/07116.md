...
> 原文:[https://hack aday . com/2020/07/09/3d-printing-a-macro-pad-switches-and-all/](https://hackaday.com/2020/07/09/3d-printing-a-macro-pad-switches-and-all/)

如今，在 3D 打印外壳内构建宏垫已经不是什么新闻了。添加 3D 打印键帽也是如此。但是如果你像[詹姆斯·斯坦利]一样，真的把开关打印出来，我们不得不承认这完全是另一回事。

[![](../Images/c8f9e7dcbb17aa963830eabf9acf4062.png)](https://hackaday.com/wp-content/uploads/2020/07/printedmacro_detail.jpg) 现在你可能想知道【詹姆斯】是如何设法打印出一个机械键盘开关的，它只有你花园里的樱桃那么大。简单的回答是他没有。虽然他的印刷开关与传统开关的占地面积相同，但它们的高度却是传统开关的两倍。
