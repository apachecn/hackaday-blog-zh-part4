...
> 原文:[https://hack aday . com/2021/03/13/its-not-a-computer-if-it-not-have-a-cartridge-slot/](https://hackaday.com/2021/03/13/its-not-a-computer-if-it-doesnt-have-a-cartridge-slot/)
...
![](../Images/53aa921e4a46f56c754ffabfe9c922c6.png)我们的同事【汤姆·纳尔迪】已经为他的网络平台找到了解决方案，其形式是 [3D 打印的弹壳，可以隐藏常规的 USB 硬件，并与插槽](https://hackaday.io/project/177861-retrocart-usb-cartridge-system)中隐藏的 USB 插座相匹配。到目前为止，他已经为闪存驱动器、WiFi 和蓝牙适配器、Wemos D1 迷你、插座和参数参考设计设计了墨盒。
