...
> 原文:[https://hack aday . com/2021/07/14/analog-style-vu-meter with arduino-and-OLED-display/](https://hackaday.com/2021/07/14/analog-style-vu-meter-with-arduino-and-oled-display/)
...
[![](../Images/b8c0e8518a452e074f4ead1e81d77250.png)](https://hackaday.com/wp-content/uploads/2021/07/oledvu_detail.jpg) 该项目的黑客日。IO page 解释说，这个想法是基于[stevenart]的工作，代码适用于 SSD1306 显示器，并对电路进行了一些调整。虽然[mircemk]说只要两个显示器没有冲突的 I2C 地址，就可以为立体声修改代码，但他决定简单地为每个通道复制整个设置，以保持简单。尽管这些零件现在很便宜，但很难责怪他。
