...
> 原文：<https://hackaday.com/2021/08/30/chordie-chording-keyboard-speaks-no-qwerty/>
...
[![An open-source chording keyboard with trackball support.](img/4803d4bcda2a572390bd71bba8fa3d3c.png)](https://hackaday.com/wp-content/uploads/2021/08/chordie-chording-kb-guts.jpg) 所以，如果你想追求荣耀，试试 [Chordie，一个时髦的小和弦键盘](https://github.com/kbjunky/Chordie)，它只用 14 个键就能完成所有的功能。[kbjunky]基于 Ginny 的和弦，这是一个可爱的小型蝙蝠翼和弦键盘，使用了最初为软键盘设计的 ASETNIOP 和弦引擎[。[kbjunky]通过印刷支架增加了开放式轨迹球支持，但没有必要使用轨迹球，因为有一对旋转编码器和一个鼠标层。](http://asetniop.com/)
