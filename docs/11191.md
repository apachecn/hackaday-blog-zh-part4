...
> 原文:[https://hack aday . com/2021/09/02/a-微控制器友好型 ar-廉价耳机/](https://hackaday.com/2021/09/02/a-microcontroller-friendly-ar-headset-on-the-cheap/)
...
[![](../Images/accab461ac14af47f37ca760d5cf57ab.png)](https://hackaday.com/wp-content/uploads/2021/08/lowfiar_detail.jpg)【bobricius】已经为这个项目整合了几个不同版本的 PCB。其中一个使用他定制的基于 at amd 21 e 18 的“ArmaBrain”模块，该模块将 MCU 和一系列常见组件封装在一个 28 mm 的方形板上，可以很容易地放入其他项目中。如果您更愿意推出自己的解决方案，第二个版本的电路板只需将两个显示器固定在适当的位置，并将 SPI 线路由至一个方便的接头即可。
