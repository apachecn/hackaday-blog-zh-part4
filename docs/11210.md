...
> 原文:[https://hack aday . com/2021/09/03/arduino-measures-20v-signals-using-quantizer/](https://hackaday.com/2021/09/03/arduino-measures-20v-signals-using-quantizer/)
...
![Oscilloscope photo showing the output signals from each of the quantizer's four op amps. They are positioned staggered on the screen so that you can see the original sinusoidal signal clearly.](../Images/85ea1044caefb02d813e49a135104782.png)
