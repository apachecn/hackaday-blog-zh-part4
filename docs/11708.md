...
> 原文:[https://hack aday . com/2021/10/23/in-search-of-the-first-comment/](https://hackaday.com/2021/10/23/in-search-of-the-first-comment/)
...
![](../Images/d67cf97fcfe95363db29040357bf1f7c.png)或者更确切地说是满手。我能找到的每一种计算机语言从一开始就有注释。FORTRAN 有注释，用“C”作为一行的第一个字符。APL 有评论，标有奇怪的符文⍝.甚至为阿波罗 11 号制导计算机编写的自定义语言也有注释——现在已经司空见惯的“#”。我找不到没有注释的早期编程语言。
