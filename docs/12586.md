...
> 原文:[https://hack aday . com/2022/02/10/kee bin-with-the-one-with-the-balu-bald-typowers/](https://hackaday.com/2022/02/10/keebin-with-kristina-the-one-with-the-ballpoint-typewriters/)
...
[![](../Images/1418c2c92afc2dd3dc078ef4810325c8.png)](https://hackaday.com/wp-content/uploads/2022/02/5-way-keebs.jpg)home 行上的每一个键都是一个五向开关——就像一个直接向下输入的 D-pad。[SouthPawEngineer]将它们设置为每个覆盖一个 QWERTY 列。所以像，对于左小手指开关，上是 Q，右是 A，下是 Z，左是 1。从技术上讲，分裂有 58 个键，而统一有 56 个键。
...
[![](../Images/48729214b2b1063d78d3c1d9cab3af20.png)](https://hackaday.com/wp-content/uploads/2022/02/physics-keyboard.jpg) 正如【Foone】在推特上指出的([ThreadReader 版)](https://threadreaderapp.com/thread/1482114631913115650.html)前几天，我们所知道的键盘布局已经从打字机及其操作限制中传承下来。但是我们可以把这些都扔出窗外，因为我们现在有了数字键盘。
...
[![](../Images/3ccca3bb4e8828b9368510aa8b3e1394.png)](https://hackaday.com/wp-content/uploads/2022/02/ballpoint-typewriter.jpg) 串行键盘设计师【deʃhipu】向我透露了[这个来自【保罗·里卡德】(](https://twitter.com/paulrickards/status/1482114631913115650) [ThreadReader 版本](https://threadreaderapp.com/thread/1482114631913115650.html))的关于圆珠笔打字机的旧 Twitter 帖子，有点像文字处理器和笔式绘图仪之间的私生子。在正常情况下，用户在键盘上打字，字符每次出现在一个小屏幕上大约 20 个，这给了它在将单词发送到打印头之前纠正错误的机会。

当通过 RS-232 串行端口连接到计算机时，这些机器可以使用 Alps 绘图仪机制和红色、蓝色、绿色和黑色的微型圆珠笔绘制从图形到图形艺术的各种东西。帖子里有很多漂亮的图片，展示了这些年来不同的品牌和型号，所以去看看吧。

## ICMYI:掌上便携式键盘无线化

[![Palm portable keyboard gone Bluettoh](../Images/7db4132073f44ed878e6dc7f798df281.png)](https://hackaday.com/wp-content/uploads/2022/02/palm-keeb-bluetooth-800.jpg) 好吧，你可能再也没有掌上设备了，但你几乎肯定会随身携带一部智能手机。如果你能使用 Palm 革命性的(当时的)折叠键盘，它能整齐地折叠成口袋大小，那不是很酷吗？是的，会的。
