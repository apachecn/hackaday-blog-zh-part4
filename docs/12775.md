...
> 原文:[https://hack aday . com/2022/02/14/a-Solaris-mechanical-digital-clock-hack-with-a little-extra/](https://hackaday.com/2022/02/14/a-solari-mechanical-digital-clock-hack-with-a-little-extra/)
...
在电子方面，最初的原型制作是用 Nucleo 32 开发板和一堆模块进行的，然后转移到 Altium Designer 中设计的定制 PCB。一个 STM32G031 运行这个节目，几个按钮和一个 SSD1306 有机发光二极管显示器形成了用户界面。![](../Images/5010e13d71f369b8c8d09b53e7fd7236.png)
