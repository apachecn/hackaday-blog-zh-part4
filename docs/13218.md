...
> 原文:[https://hackaday.com/2022/04/13/arming-with-an-os/](https://hackaday.com/2022/04/13/arming-with-an-os/)
...
[![](../Images/dc62d11bdd138288440c3b6433622210.png)](https://hackaday.com/wp-content/uploads/2022/03/2x10.png) 我用的 STLink 加密狗有 10 个 pin。不幸的是，并非所有的克隆都有相同的引脚排列。Blackpill 上的四个引脚(从左侧看连接器)是:3.3 V、SWDIO、SWCLK 和地。如果你不介意从 USB 口获得电源，你只需要最后三个引脚。
...
[![](../Images/fd8b9896da59d25de4450e535143c7b9.png)](https://hackaday.com/wp-content/uploads/2022/03/mbedide.png)
