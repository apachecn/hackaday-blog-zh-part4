...
> 原文:[https://hack aday . com/2022/04/08/a-close-look-at-little-known-8-bit-computer/](https://hackaday.com/2022/04/08/a-close-look-at-a-little-known-8-bit-computer/)
...
[![](../Images/d209ef4b2de044c36c592b5de16fa416.png)](https://hackaday.com/wp-content/uploads/2022/04/swtp_detail.jpg)SWTP 以其空白的外观闻名于世。那时候大多数电脑都有很多开关和灯。SWTP 的正面是空白的，只有一个电源开关和一个复位按钮。一个 ROM 监视器让你用一个终端使用机器。与没有接口或内存的基本型 Altair 的价格差不多，你可以选择其中一个，并附带你需要的大部分额外功能。内存只有 2K，但这比你在那个价位买到的 Altair 多了 2K。
