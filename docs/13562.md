...
> 原文:[https://hack aday . com/2022/05/07/bee-motion-combines-esp32-with-PIR-sensor-and-USB-c/](https://hackaday.com/2022/05/07/bee-motion-combines-esp32-with-pir-sensor-and-usb-c/)
...
[![](../Images/be5d4b4e352cb120d40275eb392d6700.png)](https://hackaday.com/wp-content/uploads/2022/05/beemotion_detail.png) 这款试验板兼容封装将 ESP32-S2 模块与顶部安装的 PIR 传感器相结合，使其成为各种运动检测项目的交钥匙解决方案。除了预期的板载电压调节外，还有一个 LiPo 充电控制器和状态 led，用于移动或电池供电操作。
