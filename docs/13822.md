...
> 原文:[https://hack aday . com/2022/06/03/track-your-cats-weight-through this-internet-connected-litter-box/](https://hackaday.com/2022/06/03/track-your-cats-weight-through-this-internet-connected-litter-box/)
...
[![A smartphone pop-up message from an IoT litter box](../Images/b2f7fb8fe5fcb9ac8bc698b32932e0fa.png)](https://hackaday.com/wp-content/uploads/2022/06/IoT-Litter-Box-Message.webp) 从称重传感器获得可靠的读数有点困难，因为当艾莉在垃圾箱周围移动时，测得的重量会剧烈波动。等待读数稳定下来，并使用超时来消除短暂移动的影响，这两种方法结合起来可以获得相当稳定的测量结果。分辨率甚至好到足以测量使用前后的垃圾重量差异。我们不确定知道你的猫每次拉多少屎有什么实际价值，但是如果数据在那里，你也可以记录下来。
