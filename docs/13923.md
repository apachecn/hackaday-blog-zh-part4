...
> 原文:[https://hack aday . com/2022/06/13/raspberry-pi-pico-replaces-PlayStation-memory-card/](https://hackaday.com/2022/06/13/raspberry-pi-pico-replaces-playstation-memory-card/)
...
[![](../Images/a71be3513f1e11ee5b0b34f150b57dcc.png)](https://hackaday.com/wp-content/uploads/2022/06/picomemcard_detail.png) 那么你为自己的烦恼得到了什么？首先，一个功能齐全的 PlayStation 存储卡。但更重要的是，一个带 USB 接口的存储卡可以让你将保存的游戏备份到电脑上。
