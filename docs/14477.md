...
> 原文:[https://hackaday . com/2022/08/11/want-to-use-a-classic-MAC-mouse-on-a-modern-computer-no-heres-how-do-it-anyway/](https://hackaday.com/2022/08/11/want-to-use-a-classic-mac-mouse-on-a-modern-computer-no-heres-how-to-do-it-anyway/)
...
[![](../Images/78f7c3723009a9b27b39979822b039c5.png)](https://hackaday.com/wp-content/uploads/2022/08/Macintosh-mouse-via-Arduino-adapter-0-11-screenshot.png) 为什么有这个必要？经典 Mac 鼠标上的连接器可能看起来像熟悉的 DE-9 连接器，但它不是 RS-232 设备，如果插入 9 针串行端口，它将无法工作。经典的 Mac 鼠标使用不同的引脚排列，内部没有多少大脑空间。它依赖主机直接读取其编码器和按钮状态。
