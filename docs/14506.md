...
> 原文:[https://hack aday . com/2022/08/15/re design-the-lumen PNP-tape-feeder/](https://hackaday.com/2022/08/15/redesigning-the-lumenpnp-tape-feeder/)
...
另一个值得关注的领域是盖带剥离器。重要的是，随着胶带的前进，对于每个拾取![](../Images/486c02a158df34eb0d485a0bf5929297.png)操作，覆盖膜以正确的速度剥离，并有足够的张力克服任何多余的粘性区域。最初的设计使用一个单独的电机将胶片缠绕在一个卷轴上，但这个卷轴又很宽，需要一个更窄的解决方案。这是通过将薄膜送入一对相对的直齿轮来改进的，直齿轮由蜗轮从一侧驱动。薄膜在一侧剥离，穿过进料器主体中的导槽，然后向前到达拉出机构。简单有效。
