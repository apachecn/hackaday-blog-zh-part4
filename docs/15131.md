...
> 原文:[https://hack aday . com/2022/10/20/前臂-肌肉-收缩-传感器-用于开源-修复术的有用组件/](https://hackaday.com/2022/10/20/forearm-muscle-contraction-sensor-is-useful-component-for-open-source-prosthetics/)

能够驱动假肢的一部分可以使它更加有用。为了帮助部分手臂或手截肢者实现这一目标，[turptax]开发了一种用于检测前臂肌肉收缩的传感器[。](https://www.youtube.com/watch?v=tBG6PfTKeKI)

![](../Images/be041265222f9f3e32417525356b6d51.png)
