...
> 原文:[https://hack aday . com/2022/12/02/converting-a-Porsche-944-to-run-a-MAF/](https://hackaday.com/2022/12/02/converting-a-porsche-944-to-run-a-maf/)

电子燃油喷射是发动机控制的一大飞跃。然而，早期的实现经常留下一些不尽人意的地方。[Rob]和他的保时捷 944 就是这种情况，它依赖于老式的机械式空气流量计(AFM)。他决定用一个现代质量空气流量(MAF)传感器来代替它，并在网上记录了这个过程。

![](../Images/27a00356ceb11630497c40eb633032d3.png)
