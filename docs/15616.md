...
> 原文:[https://hack aday . com/2022/12/11/laser-projector-needs-hardware-hack-after-software-mod/](https://hackaday.com/2022/12/11/laser-projector-needs-hardware-hack-after-software-mod/)
...
[![A PCB with a few mod wires on it](../Images/6d6df54b7e9fd8ff626f242d87f39b7d.png)](https://hackaday.com/wp-content/uploads/2022/12/RGB-laser-projector-bodge-wires.png) 他找到的是 [Maximus64 的 GitHub 库](https://github.com/maximus64/sd_rgb500_cfw)，里面有一个不同投影仪型号的软件模块，以及它的原始固件。刷新那个版本也没有修复[购买它修复它]的投影仪，尽管它现在开始启动它的 galvos。
