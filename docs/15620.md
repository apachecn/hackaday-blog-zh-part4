...
> 原文:[https://hack aday . com/2022/12/11/fixing-and-improving-an-Irving-apartment-entry-system/](https://hackaday.com/2022/12/11/fixing-and-improving-an-annoying-apartment-entry-system/)

[Zak]的两层公寓有一个典型的门禁控制系统，但设置并不理想方便。壁挂式的类似电话的对讲机在楼下，但是【Zak】一般在楼上。一个有事业心的黑客该怎么做？显然，最优雅的解决方案是一开始就不要访问者，但是[Zak]选择了一个功能更全面的解决方案。

![](../Images/71c8372fab2e3c461a4a24ce7836f655.png)
...
[![](../Images/415a3433f88379b0aee965020e228175.png)](https://hackaday.com/wp-content/uploads/2022/12/tg_ss-1.png) 一个这样的光隔离器工作来检测门的嗡嗡声，另一个工作来巧妙地感应和控制锁的不同状态。需要做一些额外的工作来处理 AC 门系统的特性，但是结果似乎非常好。
