...
> 原文:[https://hack aday . com/2022/12/23/与 i2s 兼容的调频调谐器合作/](https://hackaday.com/2022/12/23/working-with-i2s-compatible-fm-tuners/)
...
[![](../Images/ae4f5850597e074e58810424813e1973.png)](https://hackaday.com/wp-content/uploads/2022/12/i2sfm_detail.png)【MIT 41301】的第一次尝试是将芯片用作简单的调谐器，连接到 PIC10F200 进行控制。调查显示，它能够通过 I2S 输出数字音频，同时通过 I2C 接受指挥。默认情况下，它以 8 kHz 的低采样率输出音频，但重新配置会将采样率提高到 44.1 或 48 kHz。将数字 I2S 流通过管道输出到 DAC，然后提供模拟输出，该输出可以馈入放大器。该建筑还可以远程控制，PIC 负责解码红外信号并向无线电芯片输出命令。
