...
> 原文:[https://hack aday . com/2022/12/23/laser-scanning-microscope-build-with-blu-ray-parts/](https://hackaday.com/2022/12/23/laser-scanning-microscope-built-with-blu-ray-parts/)

激光扫描显微镜对各种微小的研究都很有用。事实证明，你可以用从蓝光播放器中回收的零件来建造一个，正如[医生伏特] 所展示的那样。

![](../Images/41c8b7e97465c37cc1dbcf2e90b7a664.png)诀窍在于重新利用通常用于读取光盘的光学拾取单元。特别是，该构建依赖于光电二极管，这些光电二极管通常用于在跟踪光盘时计算聚焦误差。为了将它变成激光扫描显微镜，光学拾取器被安装到 3D 打印组件上，该组件可以线性旋转它以进行成像。
