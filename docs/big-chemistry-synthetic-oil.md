...
API base oil groups. Note that mineral oils all have some degree of sulfur and unsaturated hydrocarbons based on the crude oil they are sourced from and the refining method. PAO base oils lack these compounds. Source: [American Petroleum Institute](https://www.api.org)
