...
> 原文：<https://hackaday.com/2022/11/19/esp32-led-eyes-help-keep-toddler-in-bed/>
...
[![](img/11c3a02c43ada0d06631695e7bfff2b4.png)](https://hackaday.com/wp-content/uploads/2022/11/eyetime_detail.jpg) 该器件内部非常简单，5mm led 及其相关电阻直接连接到 ESP32 开发板上的数字输出引脚。虽然双核微控制器被公认为每 12 小时左右翻转一些 led 有点大材小用，但固件至少从 NTP 中提取了当前时间，而且强大的微控制器提供了足够的增长空间。配置设备或检查其当前状态的 web 前端只需要几行代码。
