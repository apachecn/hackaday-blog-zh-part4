...
> 原文：<https://hackaday.com/2018/09/28/gaze-upon-this-daft-punk-helmets-rows-of-utterly-perfect-hand-soldered-leds/>

![](img/2bc185d422c46e5371726c9b535b7cf0.png)蠢朋克的标志性机器人头盔本身就是极具挑战性的 DIY 硬件项目，结果从未令人失望。但是[纳撒尼尔·斯戴普]自己版本的[照片库](https://photos.app.goo.gl/PYtMe3cTuYapNzX86)确实在质量和对细节的关注上设立了标杆。头盔使用 Teensy 3.2 作为主处理器，护目镜由 328 个手工焊接的通孔 APA106 可寻址 RGB LEDs 组成。激光切割面板作为发光二极管的框架，它是热成型的，围绕头盔弯曲，并与周围的框架配合。每个 LED 都经过精心手工焊接，配有独立的表面贴装去耦电容；没有浪费空间或多余的电线随处可见。看起来好像是一个小型的 3D 打印夹具被用来一次对齐和焊接一列或两列 led，然后被转移到遮阳板，以便与电源总线及其相邻的 led 进行最终连接。
