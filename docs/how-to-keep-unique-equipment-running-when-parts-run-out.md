...
> 原文：<https://hackaday.com/2020/04/23/how-to-keep-unique-equipment-running-when-parts-run-out/>
...
[![](img/6c6057bc6993f86065a99121a6adcb72.png)](https://hackaday.com/wp-content/uploads/2020/04/Reverse-engineering-7seg-display-thumb.jpg) 图中显示的特定部分是 [Lascar EM32-4-LED](https://www.alliedelec.com/m/d/535531da0cc330e5c959e59360401632.pdf) ，它在一个独特的设备中上升并死亡。麻烦的是 EM32-4-LED 已经停产，无法获得，驱动整个事情的可编程逻辑控制器(PLC)是一个无法修改的黑匣子。数据表的存在是一个好消息，但这通常只是一个起点。要创建一次性的嵌入式解决方案，需要结合研究、故障排除和设计工作。
